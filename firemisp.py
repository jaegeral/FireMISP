...
def check_for_previous_events(fireinstance):
...
def map_alert_to_event(auto_comment, event, fireinstance):
    ...
    if fireinstance.malware_md5:
        ...
        misp.add_hashes(event, "Payload delivery", fireinstance.malware_file_name, fireinstance.malware_md5, None, None,
